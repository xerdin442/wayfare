...
type Driver struct {
	...
	TotalCompletedTrips int32                  `protobuf:"varint,11,opt,name=total_completed_trips,json=totalCompletedTrips,proto3" json:"total_completed_trips,omitempty"`
...
func (x *Driver) GetTotalCompletedTrips() int32 {
	if x != nil {
...
const file_schema_proto_rawDesc = "" +
	...
	"\x15total_completed_trips\x18\v \x01(\x05R\x13totalCompletedTrips\x12\x12\n" +
